...
QQmlListProperty<CHTTPRawHeaderFormat> CHTTPBase::listOfRawHeaders()
{
    return QQmlListProperty<CHTTPRawHeaderFormat>(this, &m_listOfRawHeaders );
}
...
const QString &CHTTPRawHeaderFormat::headerName() const
{
    return m_headerName;
}
...
const QString &CHTTPRawHeaderFormat::headerValue() const
{
