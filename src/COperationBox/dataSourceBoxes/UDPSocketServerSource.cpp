...
int CUDPSocketServerSource::serverPortNum() const
{
...
void CUDPSocketServerSource::setServerPortNum(int newServerPortNum)
{
    ...
    if (mp_udpServer && !mp_udpServer->bind(QHostAddress::Any, newServerPortNum , QAbstractSocket::DefaultForPlatform)) {  // Start on a new port
