...
{
  public:
    explicit CBitWiseLeftShiftVisitor(CRawValueBase* rhs) : mp_rhs(rhs) {}
...
CBitWiseLeftShift::CBitWiseLeftShift(int newBlueBox_xPos, int newBlueBox_yPos, QObject* parent) : COperationBox{m_uniqueBoxName, newBlueBox_xPos, newBlueBox_yPos, blueBoxWidth, blueBoxHeight, parent}
{
