...
{
  public:
    explicit CBitWiseXORVisitor(CRawValueBase* rhs) : mp_rhs(rhs) {}
...
CBitWiseXOR::CBitWiseXOR(int newBlueBox_xPos, int newBlueBox_yPos, QObject* parent) : COperationBox{m_uniqueBoxName, newBlueBox_xPos, newBlueBox_yPos, blueBoxWidth, blueBoxHeight, parent}
{
    m_blueBox_GUIType = CBPStatic::EBPDelegateGUIType::E_BigTextOperator;
    m_blueBox_HeadColor = QColor(137, 129, 33);
