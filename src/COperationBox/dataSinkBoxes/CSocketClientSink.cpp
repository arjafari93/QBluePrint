...
int CSocketClientSink::remotePortNum() const
{
    return m_remotePortNum;
}
...
const QAbstractSocket::SocketState &CSocketClientSink::clientSocketState() const
{
    return m_clientSocketState;
}
...
const QAbstractSocket::SocketType &CSocketClientSink::socketType() const
{
    return m_socketType;
}
...
const QString &CSocketClientSink::remoteServerIPAddress() const
{
