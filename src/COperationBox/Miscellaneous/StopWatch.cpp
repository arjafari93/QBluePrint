...
CStopWatch::CStopWatch(int newBlueBox_xPos, int newBlueBox_yPos, QObject* parent) : COperationBox{m_uniqueBoxName, newBlueBox_xPos, newBlueBox_yPos, blueBoxWidth + 30, blueBoxHeight - 30, parent}
{
...
CStopWatch::~CStopWatch() { mp_internalTimer->stop(); }
...
bool CStopWatch::stopWatchRunning() const { return m_stopWatchRunning; }
...
int CStopWatch::elapsedTime() const { return m_elapsedTime; }
