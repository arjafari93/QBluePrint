...
public:
    ...
    explicit CDataComparisonGreaterVisitor(CRawValueBase* rhs) : mp_rhs(rhs) {}
...
CDataComparisonGreater::CDataComparisonGreater ( int newBlueBox_xPos, int newBlueBox_yPos , QObject *parent)
    : COperationBox{ m_uniqueBoxName  , newBlueBox_xPos  , newBlueBox_yPos  , blueBoxWidth , blueBoxHeight , parent }
{
    ...
    m_blueBox_HeadColor = QColor(200, 130, 255);
