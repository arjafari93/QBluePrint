...
Popup {
    ...
    Rectangle{
        ...
        MouseArea{
            ...
            onClicked: {
                var tempComp = Qt.createComponent("qrc:/org/QBluePrint/GUI/QML/BluePrintBoxes/SingleTerminalInstance/AddNewArrayElementPopup.qml");
        ...
        Item {
            ...
            Rectangle{
                ...
                MouseArea{
                    ...
                    cursorShape: Qt.PointingHandCursor
                    onClicked: {
                        var tempComp = Qt.createComponent("qrc:/org/QBluePrint/GUI/QML/BluePrintBoxes/SingleTerminalInstance/ArrayValueModifierPopUp.qml");
