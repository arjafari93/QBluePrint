...
#define ASSERTWITHINFO(toBeAsser)                                                                                                                                                                      \
    if (!(toBeAsser))                                                                                                                                                                                  \
    {                                                                                                                                                                                                  \
        DEBUG_MSG_PRINT << "\033[31mAssertion failed \033[0m";                                                                                                                                         \
        return;                                                                                                                                                                                        \
    }
#endif

#ifndef ASSERTWITHMSG
#define ASSERTWITHMSG(toBeAsser, MsgToBePrinted)                                                                                                                                                       \
    if (!(toBeAsser))                                                                                                                                                                                  \
    {                                                                                                                                                                                                  \
        DEBUG_MSG_PRINT << "\033[31mAssertion failed \033[0m" << (MsgToBePrinted);                                                                                                                     \
        return;                                                                                                                                                                                        \
    }
#endif

#ifndef ASSERTWITHRETURN
#define ASSERTWITHRETURN(toBeAsser, toBeReturn)                                                                                                                                                        \
    if (!(toBeAsser))                                                                                                                                                                                  \
    {                                                                                                                                                                                                  \
        DEBUG_MSG_PRINT << "\033[31mAssertion failed \033[0m";                                                                                                                                         \
        return (toBeReturn);                                                                                                                                                                           \
...
#define GETUNIQUENAMEFUNC                                                                                                                                                                              \
  public:                                                                                                                                                                                              \
    static QString getUniqueName() { return m_uniqueBoxName; }
#endif
