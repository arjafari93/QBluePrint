...
public:
    ...
    Q_DECL_DEPRECATED  explicit CFlowConnectionLine( int newFlowLine_startX ,
                                  int newflowLine_startY ,
                                  int newFlowLine_endX   ,
                                  int newFlowLine_endY   ,
                                  QObject *parent = nullptr);

    explicit CFlowConnectionLine( COutputTerminal * pStartTerminal,
                                  QObject *parent = nullptr);
