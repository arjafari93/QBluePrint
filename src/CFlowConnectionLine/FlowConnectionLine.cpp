...
CFlowConnectionLine::CFlowConnectionLine(int newFlowLine_startX, int newflowLine_startY, int newFlowLine_endX, int newFlowLine_endY,
                                         /*int newFlowLine_ctrl1X, int newFlowLine_ctrl1Y, int newFlowLine_ctrl2X, int newFlowLine_ctrl2Y,*/ QObject* parent)
    : QObject{parent}, m_flowLine_startX{newFlowLine_startX}, m_flowLine_startY{newflowLine_startY}, m_flowLine_endX{newFlowLine_endX}, m_flowLine_endY{newFlowLine_endY}
{
}
...
void CFlowConnectionLine::setFlowLine_strokeWidth(const int& newValue)
{
    if (m_flowLine_strokeWidth == newValue)
        return;
    m_flowLine_strokeWidth = newValue;
    emit flowLine_strokeWidthChanged();
}

void CFlowConnectionLine::setFlowLine_startX(const int& newValue)
{
    if (m_flowLine_startX == newValue)
        return;
    m_flowLine_startX = newValue;
    emit flowLine_startXChanged();
}
void CFlowConnectionLine::setFlowLine_startY(const int& newValue)
{
    if (m_flowLine_startY == newValue)
        return;
    m_flowLine_startY = newValue;
    emit flowLine_startYChanged();
}
void CFlowConnectionLine::setFlowLine_endX(const int& newValue)
{
    if (m_flowLine_endX == newValue)
        return;
    m_flowLine_endX = newValue;
    emit flowLine_endXChanged();
}
void CFlowConnectionLine::setFlowLine_endY(const int& newValue)
{
    if (m_flowLine_endY == newValue)
        return;
    m_flowLine_endY = newValue;
    emit flowLine_endYChanged();
}

const QColor& CFlowConnectionLine::flowLine_color() const { return m_flowLine_color; }
